module Contexts
  ...
  # load './app/services/survey_service_v2.rb'
      def create_stuff
        ...
        # 4/6/2018
        @practice_1_april_6 = Practice.create(team: @m_soccer, duration: 120, difficulty: 6, practice_time: Time.new(2018,4,16,8,30,0,'-04:00'))
        @practice_1_april_5 = Practice.create(team: @m_soccer, duration: 0, difficulty: 0, practice_time: Time.new(2018,4,15,11,0,0,'-04:00'))
        @practice_1_april_4 = Practice.create(team: @m_soccer, duration: 30, difficulty: 2, practice_time: Time.new(2018,4,14,13,0,0,'-04:00'))
        @practice_1_april_3 = Practice.create(team: @m_soccer, duration: 90, difficulty: 4, practice_time: Time.new(2018,4,13,12,0,0,'-04:00'))
        @practice_1_april_2 = Practice.create(team: @m_soccer, duration: 180, difficulty: 9, practice_time: Time.new(2018,4,12,19,0,0,'-04:00'))
        @practice_2_april_1 = Practice.create(team: @m_soccer, duration: 120, difficulty: 7, practice_time: Time.new(2018,4,11,16,0,0,'-04:00'))
        @practice_1_april_1 = Practice.create(team: @m_soccer, duration: 120, difficulty: 1, practice_time: Time.new(2018,4,10,6,0,0,'-04:00'))
        @practice_1_march_31 = Practice.create(team: @m_soccer, duration: 60, difficulty: 5, practice_time: Time.new(2018,4,9,16,30,0,'-04:00'))
        @practice_1_march_30 = Practice.create(team: @m_soccer, duration: 120, difficulty: 8, practice_time: Time.new(2018,4,8,16,0,0,'-04:00'))
        @swim_practice_1_april_6 = Practice.create(team: @w_swim, duration: 120, difficulty: 6, practice_time: Time.new(2018,4,16,8,30,0,'-04:00'))
        @swim_practice_1_april_5 = Practice.create(team: @w_swim, duration: 0, difficulty: 0, practice_time: Time.new(2018,4,15,11,0,0,'-04:00'))
        @swim_practice_1_april_4 = Practice.create(team: @w_swim, duration: 30, difficulty: 2, practice_time: Time.new(2018,4,14,13,0,0,'-04:00'))
        @swim_practice_1_april_3 = Practice.create(team: @w_swim, duration: 90, difficulty: 4, practice_time: Time.new(2018,4,13,12,0,0,'-04:00'))
        @swim_practice_1_april_2 = Practice.create(team: @w_swim, duration: 180, difficulty: 9, practice_time: Time.new(2018,4,12,19,0,0,'-04:00'))
        @swim_practice_2_april_1 = Practice.create(team: @w_swim, duration: 120, difficulty: 7, practice_time: Time.new(2018,4,11,16,0,0,'-04:00'))
        @swim_practice_1_april_1 = Practice.create(team: @w_swim, duration: 120, difficulty: 1, practice_time: Time.new(2018,4,10,6,0,0,'-04:00'))
        @swim_practice_1_march_31 = Practice.create(team: @w_swim, duration: 60, difficulty: 5, practice_time: Time.new(2018,4,9,16,30,0,'-04:00'))
        @swim_practice_1_march_30 = Practice.create(team: @w_swim, duration: 120, difficulty: 8, practice_time: Time.new(2018,4,8,16,0,0,'-04:00'))
        ...
        survey_post_1_march_30_service_alec  = SurveyService.new({
                                        ...
                                        datetime_today: Time.new(2018,4,8,23,59,59,'-04:00'),
                                        player_rpe_rating: 8,
        ...
        survey_post_1_march_31_service_alec = SurveyService.new({
                                        ...
                                        survey_type: 'Post-Practice',
                                        # for testing dates and stuff
                                        datetime_today: Time.new(2018,4,9,23,59,59,'-04:00'),
                                        player_rpe_rating: 6,
        ...
        survey_post_1_april_1_service_alec  = SurveyService.new({
                                        ...
                                        survey_type: 'Post-Practice',
                                        # for testing dates and stuff
                                        datetime_today: Time.new(2018,4,10,23,59,59,'-04:00'),
                                        player_rpe_rating: 0,
        ...
        survey_post_2_april_1_service_alec  = SurveyService.new({
                                        ...
                                        survey_type: 'Post-Practice',
                                        # for testing dates and stuff
                                        datetime_today: Time.new(2018,4,11,23,59,59,'-04:00'),
                                        player_rpe_rating: 5,
                                        player_personal_performance: 9,
        ...
        survey_post_1_april_2_service_alec  = SurveyService.new({
                                        ...
                                        survey_type: 'Post-Practice',
                                        # for testing dates and stuff
                                        datetime_today: Time.new(2018,4,12,23,59,59,'-04:00'),
                                        player_rpe_rating: 5,
                                        player_personal_performance: 9,
                                        participated_in_full_practice: false,
                                        minutes_participated: 60
        ...
        survey_post_1_april_3_service_alec  = SurveyService.new({
                                        ...
                                        survey_type: 'Post-Practice',
                                        # for testing dates and stuff
                                        datetime_today: Time.new(2018,4,13,23,59,59,'-04:00'),
                                        player_rpe_rating: 3,
        ...
        survey_post_1_april_4_service_alec  = SurveyService.new({
                                        ...
                                        survey_type: 'Post-Practice',
                                        # for testing dates and stuff
                                        datetime_today: Time.new(2018,4,14,23,59,59,'-04:00'),
                                        player_rpe_rating: 3,
                                        player_personal_performance: 8,
                                        participated_in_full_practice: true,
                                        minutes_participated: nil
        ...
        survey_post_1_april_5_service_alec  = SurveyService.new({
                                        ...
                                        survey_type: 'Post-Practice',
                                        # for testing dates and stuff
                                        datetime_today: Time.new(2018,4,15,23,59,59,'-04:00'),
                                        player_rpe_rating: 0,
        ...
        survey_post_1_april_6_service_alec = SurveyService.new({
                                        ...
                                        survey_type: 'Post-Practice',
                                        # for testing dates and stuff
                                        datetime_today: Time.new(2018,4,16,23,59,59,'-04:00'),
                                        player_rpe_rating: 5,
        ...
        # March 30, 2018
        survey_post_1_march_30_service_zack  = SurveyService.new({
                                        user_id: @zack.id,
                                        team_id: @m_soccer.id,
                                        practice_id: @practice_1_march_30.id,
                                        survey_type: 'Post-Practice',
        ...
        # March 31, 2018
        survey_post_1_march_31_service_zack = SurveyService.new({
                                        user_id: @zack.id,
                                        team_id: @m_soccer.id,
                                        practice_id: @practice_1_march_31.id,
                                        survey_type: 'Post-Practice',
        ...
        # April 1, 2018 SESSION 1
        survey_post_1_april_1_service_zack  = SurveyService.new({
                                        user_id: @zack.id,
                                        team_id: @m_soccer.id,
                                        practice_id: @practice_1_april_1.id,
                                        survey_type: 'Post-Practice',
        ...
        # April 1, 2018 SESSION 2
        survey_post_2_april_1_service_zack  = SurveyService.new({
                                        user_id: @zack.id,
                                        team_id: @m_soccer.id,
                                        practice_id: @practice_2_april_1.id,
                                        survey_type: 'Post-Practice',
        ...
        # April 2, 2018
        survey_post_1_april_2_service_zack  = SurveyService.new({
                                        user_id: @zack.id,
                                        team_id: @m_soccer.id,
                                        practice_id: @practice_1_april_2.id,
                                        survey_type: 'Post-Practice',
        ...
        # April 3, 2018
        survey_post_1_april_3_service_zack  = SurveyService.new({
                                        user_id: @zack.id,
                                        team_id: @m_soccer.id,
                                        practice_id: @practice_1_april_3.id,
                                        survey_type: 'Post-Practice',
        ...
        # April 4, 2018
        survey_post_1_april_4_service_zack  = SurveyService.new({
                                        user_id: @zack.id,
                                        team_id: @m_soccer.id,
                                        practice_id: @practice_1_april_4.id,
                                        survey_type: 'Post-Practice',
        ...
        # April 6, 2018
        survey_post_1_april_6_service_zack = SurveyService.new({
                                        user_id: @zack.id,
                                        team_id: @m_soccer.id,
                                        practice_id: @practice_1_april_6.id,
                                        survey_type: 'Post-Practice',
        ...
        # March 30, 2018
        survey_dw_march_30_service_zack = SurveyService.new({
                                        user_id: @zack.id,
                                        team_id: @m_soccer.id,
                                        survey_type: 'Daily Wellness',
                                        # for testing dates and stuff
        ...
        # March 31, 2018
        survey_dw_march_31_service_zack = SurveyService.new({
                                        user_id: @zack.id,
                                        team_id: @m_soccer.id,
                                        survey_type: 'Daily Wellness',
                                        # for testing dates and stuff
        ...
        # April 1, 2018
        survey_dw_april_1_service_zack = SurveyService.new({
                                        user_id: @zack.id,
                                        team_id: @m_soccer.id,
                                        survey_type: 'Daily Wellness',
                                        # for testing dates and stuff
                                        ...
                                        life_stress: 3,
                                        soreness: 1,
                                        ounces_of_water_consumed: 65,
                                        hydration_quality: true
                                       })
        @survey_dw_april_1_zack = survey_dw_april_1_service_zack.get_survey_object
  
        # April 2, 2018
        survey_dw_april_2_service_zack = SurveyService.new({
                                        user_id: @zack.id,
                                        team_id: @m_soccer.id,
                                        survey_type: 'Daily Wellness',
                                        # for testing dates and stuff
                                        ...
                                        life_stress: 3,
                                        soreness: 5,
                                        ounces_of_water_consumed: 80,
                                        hydration_quality: true
                                       })
        @survey_dw_april_2_zack = survey_dw_april_2_service_zack.get_survey_object
  
        # April 3, 2018
        survey_dw_april_3_service_zack = SurveyService.new({
                                        user_id: @zack.id,
                                        team_id: @m_soccer.id,
                                        survey_type: 'Daily Wellness',
                                        # for testing dates and stuff
        ...
        # April 4, 2018
        survey_dw_april_4_service_zack = SurveyService.new({
                                        user_id: @zack.id,
                                        team_id: @m_soccer.id,
                                        survey_type: 'Daily Wellness',
                                        # for testing dates and stuff
        ...
        # April 5, 2018
        survey_dw_april_5_service_zack = SurveyService.new({
                                        user_id: @zack.id,
                                        team_id: @m_soccer.id,
                                        survey_type: 'Daily Wellness',
                                        # for testing dates and stuff
        ...
        # April 6, 2018
        survey_dw_april_6_service_zack = SurveyService.new({
                                        user_id: @zack.id,
                                        team_id: @m_soccer.id,
                                        survey_type: 'Daily Wellness',
                                        # for testing dates and stuff
        ...
        # March 30, 2018
        survey_post_1_march_30_service_sam  = SurveyService.new({
                                        user_id: @sam.id,
                                        team_id: @m_soccer.id,
                                        practice_id: @practice_1_march_30.id,
                                        survey_type: 'Post-Practice',
        ...
        # March 31, 2018
        survey_post_1_march_31_service_sam = SurveyService.new({
                                        user_id: @sam.id,
                                        team_id: @m_soccer.id,
                                        practice_id: @practice_1_march_31.id,
                                        survey_type: 'Post-Practice',
        ...
        # April 1, 2018 SESSION 1
        survey_post_1_april_1_service_sam  = SurveyService.new({
                                        user_id: @sam.id,
                                        team_id: @m_soccer.id,
                                        practice_id: @practice_1_april_1.id,
                                        survey_type: 'Post-Practice',
        ...
        # April 1, 2018 SESSION 2
        survey_post_2_april_1_service_sam  = SurveyService.new({
                                        user_id: @sam.id,
                                        team_id: @m_soccer.id,
                                        practice_id: @practice_2_april_1.id,
                                        survey_type: 'Post-Practice',
        ...
        # April 2, 2018
        survey_post_1_april_2_service_sam  = SurveyService.new({
                                        user_id: @sam.id,
                                        team_id: @m_soccer.id,
                                        practice_id: @practice_1_april_2.id,
                                        survey_type: 'Post-Practice',
        ...
        # April 3, 2018
        survey_post_1_april_3_service_sam  = SurveyService.new({
                                        user_id: @sam.id,
                                        team_id: @m_soccer.id,
                                        practice_id: @practice_1_april_3.id,
                                        survey_type: 'Post-Practice',
        ...
        # April 4, 2018
        survey_post_1_april_4_service_sam  = SurveyService.new({
                                        user_id: @sam.id,
                                        team_id: @m_soccer.id,
                                        practice_id: @practice_1_april_4.id,
                                        survey_type: 'Post-Practice',
        ...
        # April 6, 2018
        survey_post_1_april_6_service_sam = SurveyService.new({
                                        user_id: @sam.id,
                                        team_id: @m_soccer.id,
                                        practice_id: @practice_1_april_6.id,
                                        survey_type: 'Post-Practice',
        ...
        # March 30, 2018
        survey_dw_march_30_service_sam = SurveyService.new({
                                        user_id: @sam.id,
                                        team_id: @m_soccer.id,
                                        survey_type: 'Daily Wellness',
                                        # for testing dates and stuff
                                        ...
                                        life_stress: 1,
                                        soreness: 3,
                                        ounces_of_water_consumed: 10,
                                        hydration_quality: false
                                       })
        @survey_dw_march_30_sam = survey_dw_march_30_service_sam.get_survey_object
  
        # March 31, 2018
        survey_dw_march_31_service_sam = SurveyService.new({
                                        user_id: @sam.id,
                                        team_id: @m_soccer.id,
                                        survey_type: 'Daily Wellness',
                                        # for testing dates and stuff
        ...
        # April 1, 2018
        survey_dw_april_1_service_sam = SurveyService.new({
                                        user_id: @sam.id,
                                        team_id: @m_soccer.id,
                                        survey_type: 'Daily Wellness',
                                        # for testing dates and stuff
                                        ...
                                        life_stress: 2,
                                        soreness: 2,
                                        ounces_of_water_consumed: 25,
                                        hydration_quality: false
                                       })
        @survey_dw_april_1_sam = survey_dw_april_1_service_sam.get_survey_object
  
        # April 2, 2018
        survey_dw_april_2_service_sam = SurveyService.new({
                                        user_id: @sam.id,
                                        team_id: @m_soccer.id,
                                        survey_type: 'Daily Wellness',
                                        # for testing dates and stuff
        ...
        # April 3, 2018
        survey_dw_april_3_service_sam = SurveyService.new({
                                        user_id: @sam.id,
                                        team_id: @m_soccer.id,
                                        survey_type: 'Daily Wellness',
                                        # for testing dates and stuff
        ...
        # April 4, 2018
        survey_dw_april_4_service_sam = SurveyService.new({
                                        user_id: @sam.id,
                                        team_id: @m_soccer.id,
                                        survey_type: 'Daily Wellness',
                                        # for testing dates and stuff
        ...
        # April 5, 2018
        survey_dw_april_5_service_sam = SurveyService.new({
                                        user_id: @sam.id,
                                        team_id: @m_soccer.id,
                                        survey_type: 'Daily Wellness',
                                        # for testing dates and stuff
        ...
        # March 30, 2018
        survey_post_1_march_30_service_allie  = SurveyService.new({
          user_id: @llie.id,
          team_id: @w_swim.id,
          practice_id: @swim_practice_1_march_30.id,
          survey_type: 'Post-Practice',
          # for testing dates and stuff
          datetime_today: Time.new(2018,4,8,23,59,59,'-04:00'),
          player_rpe_rating: 8,
  ...
  # March 31, 2018
  survey_post_1_march_31_service_allie = SurveyService.new({
          user_id: @llie.id,
          team_id: @w_swim.id,
          practice_id: @swim_practice_1_march_31.id,
          survey_type: 'Post-Practice',
          # for testing dates and stuff
          datetime_today: Time.new(2018,4,9,23,59,59,'-04:00'),
          player_rpe_rating: 8,
  ...
  # April 1, 2018 SESSION 1
  survey_post_1_april_1_service_allie  = SurveyService.new({
          user_id: @llie.id,
          team_id: @w_swim.id,
          practice_id: @swim_practice_1_april_1.id,
          survey_type: 'Post-Practice',
          # for testing dates and stuff
          datetime_today: Time.new(2018,4,10,23,59,59,'-04:00'),
          player_rpe_rating: 8,
  ...
  # April 1, 2018 SESSION 2
  survey_post_2_april_1_service_allie  = SurveyService.new({
          user_id: @llie.id,
          team_id: @w_swim.id,
          practice_id: @swim_practice_2_april_1.id,
          survey_type: 'Post-Practice',
          # for testing dates and stuff
          datetime_today: Time.new(2018,4,11,23,59,59,'-04:00'),
          player_rpe_rating: 8,
  ...
  # April 2, 2018
  survey_post_1_april_2_service_allie  = SurveyService.new({
          user_id: @llie.id,
          team_id: @w_swim.id,
          practice_id: @swim_practice_1_april_2.id,
          survey_type: 'Post-Practice',
          # for testing dates and stuff
          datetime_today: Time.new(2018,4,12,23,59,59,'-04:00'),
          player_rpe_rating: 8,
  ...
  # April 3, 2018
  survey_post_1_april_3_service_allie  = SurveyService.new({
          user_id: @llie.id,
          team_id: @w_swim.id,
          practice_id: @swim_practice_1_april_3.id,
          survey_type: 'Post-Practice',
          # for testing dates and stuff
          datetime_today: Time.new(2018,4,13,23,59,59,'-04:00'),
          player_rpe_rating: 7,
  ...
  # April 4, 2018
  survey_post_1_april_4_service_allie  = SurveyService.new({
          user_id: @llie.id,
          team_id: @w_swim.id,
          practice_id: @swim_practice_1_april_4.id,
          survey_type: 'Post-Practice',
          # for testing dates and stuff
          datetime_today: Time.new(2018,4,14,23,59,59,'-04:00'),
          player_rpe_rating: 5,
  ...
  # April 5, 2018 OFF DAY
  survey_post_1_april_5_service_allie  = SurveyService.new({
          user_id: @llie.id,
          team_id: @w_swim.id,
          practice_id: @swim_practice_1_april_5.id,
          survey_type: 'Post-Practice',
          # for testing dates and stuff
          datetime_today: Time.new(2018,4,15,23,59,59,'-04:00'),
          player_rpe_rating: 0,
  ...
  # April 6, 2018
  survey_post_1_april_6_service_allie = SurveyService.new({
          user_id: @llie.id,
          team_id: @w_swim.id,
          practice_id: @swim_practice_1_april_6.id,
          survey_type: 'Post-Practice',
          # for testing dates and stuff
          datetime_today: Time.new(2018,4,16,23,59,59,'-04:00'),
          player_rpe_rating: 7,
  ...
  # March 30, 2018
  survey_dw_march_30_service_allie = SurveyService.new({
          user_id: @llie.id,
          team_id: @w_swim.id,
          survey_type: 'Daily Wellness',
          # for testing dates and stuff
  ...
  # March 31, 2018
  survey_dw_march_31_service_allie = SurveyService.new({
          user_id: @llie.id,
          team_id: @w_swim.id,
          survey_type: 'Daily Wellness',
          # for testing dates and stuff
  ...
  # April 1, 2018
  survey_dw_april_1_service_allie = SurveyService.new({
          user_id: @llie.id,
          team_id: @w_swim.id,
          survey_type: 'Daily Wellness',
          # for testing dates and stuff
  ...
  # April 2, 2018
  survey_dw_april_2_service_allie = SurveyService.new({
          user_id: @llie.id,
          team_id: @w_swim.id,
          survey_type: 'Daily Wellness',
          # for testing dates and stuff
  ...
  # April 3, 2018
  survey_dw_april_3_service_allie = SurveyService.new({
          user_id: @llie.id,
          team_id: @w_swim.id,
          survey_type: 'Daily Wellness',
          # for testing dates and stuff
  ...
  # April 4, 2018
  survey_dw_april_4_service_allie = SurveyService.new({
          user_id: @llie.id,
          team_id: @w_swim.id,
          survey_type: 'Daily Wellness',
          # for testing dates and stuff
  ...
  # April 5, 2018
  survey_dw_april_5_service_allie = SurveyService.new({
          user_id: @llie.id,
          team_id: @w_swim.id,
          survey_type: 'Daily Wellness',
          # for testing dates and stuff
  ...
  # April 6, 2018
  survey_dw_april_6_service_allie = SurveyService.new({
          user_id: @llie.id,
          team_id: @w_swim.id,
          survey_type: 'Daily Wellness',
          # for testing dates and stuff
